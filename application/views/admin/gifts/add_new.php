<div class="page-content">
   <div class="container-fluid">
      ...
      <!-- end page title -->
      <?= form_open_multipart('admin/gift/process', 'class="custom-validation"');?>
               ...
               <div class="card">
                  ...
                  <div class="card-body">
                    <div class="mb-3">
                        ...
                        <div>
                           <input data-parsley-type="text" type="text" class="form-control" required placeholder="Enter Title" name="gift_title" id="tamo">
                        </div>
                    </div> 
                    <div class="mb-3">
                        <label class="form-label" id="tamo">Gift Amount</label>
                        <div>
                           <input data-parsley-type="number" type="number" class="form-control" required placeholder="Enter Amount" name="gift_amount" id="tamo">
                        </div>
                    </div>  
                    <div class="mb-3">
                        <label class="form-label" id="tamo">Target Amount</label>
                        <div>
                           <input data-parsley-type="number" type="number" class="form-control" required placeholder="Enter Amount" name="fetch_amount" id="tamo">
                        </div>
                    </div>  
                     <div class="mb-3">
