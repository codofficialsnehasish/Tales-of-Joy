<div class="page-content">
   <div class="container-fluid">
         ...
         <div class="row align-items-center">
            ...
            <div class="col-md-4">
               <div class="float-end d-none d-md-block">
                  <div class="dropdown">
                     <a href="<?= admin_url('slider/')?>" class="btn btn-primary  dropdown-toggle" aria-expanded="false">
      ...
      <!-- end page title -->
      <?= form_open_multipart('admin/slider/update-process/'.$item->id, 'class="custom-validation"');?>
                     ...
                     <div class="mb-3">
                        ...
                        <div>
                           <input data-parsley-type="text" type="text"
                              ...
                              placeholder="Enter Title" name="name" value="<?= $item->name;?>">
                        </div>
                     </div>
