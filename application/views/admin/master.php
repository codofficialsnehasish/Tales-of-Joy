<?php $this->load->view('admin/partials/main');?>
    ...
    <head> 
        ...
        <link href="<?= base_url('assets/admin/libs/chartist/chartist.min.css');?>" rel="stylesheet">
    ...
    <?php $this->load->view('admin/partials/body');?>
        ...
        <!-- END layout-wrapper -->
        <?php $this->load->view('admin/partials/right-sidebar');?>
        

        <?php $this->load->view('admin/partials/vendor-script');?>
