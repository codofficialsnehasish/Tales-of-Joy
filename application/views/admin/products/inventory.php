<div class="page-content">
   <div class="container-fluid">
      ...
      <!-- end page title -->
      <?= form_open_multipart('admin/products/inventory_process', 'class="custom-validation"');?>
        <div class="row">
            <div class="col-lg-9">
            <div class="card">
                <div class="card-body">
                           ...
                           <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="form-check">
                                    <input type="checkbox" id="check123" name="is_stock_manage" value="0">
                                    <label class="form-check-label" for="check123">Track stock quantity for this product</label>
                                </div>
                            </div>
                            <div class="mb-3" id="oprnclosed" style="display:none;">
                                <label class="form-label">Quantity</label>
                                <div>
                                    <input type="number" class="form-control" value="1" required placeholder="Enter Title" name="qty">
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                <div>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="stockstatus" value="1" style="margin-right: 15px;" checked>In stock
                                        </label>
                                    </div>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="stockstatus" value="0" style="margin-right: 15px;">Out of stock
                                        </label>
                                    </div>
                                </div>
                            </div>
