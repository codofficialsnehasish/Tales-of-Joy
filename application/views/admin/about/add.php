<div class="page-content">
   <div class="container-fluid">
         ...
         <div class="row align-items-center">
            <div class="col-md-8">
               ...
               <ol class="breadcrumb m-0">
                  ...
                  <li class="breadcrumb-item"><a href="<?= admin_url('slider')?>">About</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Add new About</li>
               </ol>
            </div>
            <div class="col-md-4">
      ...
      <!-- end page title -->
      <?= form_open_multipart('admin/about/process', 'class="custom-validation"');?>
         ...
         <div class="row">
            ...
            <div class="col-lg-3">
               <div class="card">
                  ...
                  <div class="card-body">
                     <div class="mb-3">
                        <label class="form-label mb-3 d-flex">Content Visiblity</label>
