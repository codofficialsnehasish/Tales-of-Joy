                    ...
                    <div class="container-fluid">
                        ...
                        <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h6 class="page-title">Contacts</h6>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        data-bs-target="#messageModal<?= $item->c_id;?>">
                                                                <i class="fas fa-search-plus" data-bs-toggle="tooltip" data-bs-placement="top" 
                                                        title="View Message" title="View Message"></i>
                                                            </a>
                                                            <a class="btn btn-danger btn-sm edit" onclick="confirmDelete(this.id,'contact');" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove this Item" id="<?= $item->c_id;?>">
                                                                <i class="fas fa-trash-alt" title="Remove"></i>
                                                            </a></td>
                                                </tr>

                                                <div class="modal fade" id="messageModal<?= $item->c_id;?>" tabindex="-1" role="dialog"
