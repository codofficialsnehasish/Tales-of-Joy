                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4">
                                    <div class="float-end d-none d-md-block">
                                        <div class="dropdown">
                                        <a href="<?= admin_url('custom-fields/add-new')?>" class="btn btn-primary  dropdown-toggle" aria-expanded="false">
                                    ...
                                    <div class="card-body">
                                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?= $i++;?></td>
                                                    <td><a href="<?= admin_url('custom-fields/edit/'.$item->page_id);?>"><?= $item->page_title;?></a></td>
                                                    <!-- <td><?= $item->page_name;?></td> -->
                                                    <td><?= check_visibility($item->is_visible);?> </td>
                                                    <!-- <td><?= check_popular($item->is_popular);?> </td> -->
                                                    <td>
                                                        <a href="<?= admin_url('custom-fields/edit/'.$item->page_id);?>" class="btn btn-primary btn-sm edit" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit this Item">
