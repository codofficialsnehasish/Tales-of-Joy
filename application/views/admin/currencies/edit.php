   ...
   <div class="container-fluid">
      ...
      <div class="page-title-box">
         <div class="row align-items-center">
            <div class="col-md-8">
               <h6 class="page-title">Currency</h6>
               <ol class="breadcrumb m-0">
                  <li class="breadcrumb-item"><a href="<?= admin_url('')?>">Home</a></li>
                  <li class="breadcrumb-item"><a href="<?= admin_url('currencies/')?>">Currency</a></li>
            ...
            <div class="col-md-4">
               <div class="float-end d-none d-md-block">
                  <div class="dropdown">
                     <a href="<?= admin_url('currencies/')?>" class="btn btn-primary  dropdown-toggle" aria-expanded="false">
      ...
      <!-- end page title -->
      <?= form_open_multipart('admin/currencies/update-process/'.$item->id, 'class="custom-validation"');?>
                  ...
                  <div class="card-body">
                     ...
                     <div class="mb-3">
                        ...
                        <div>
                           <input data-parsley-type="text" type="text"
                              class="form-control" required
                              placeholder="Enter Title" name="code" value="<?= $item->code;?>" required>
                        </div>
                     </div>
                     <div class="mb-3">
                        ...
                        <div>
                           <input data-parsley-type="text" type="text"
                              class="form-control" required
                              placeholder="Enter Title" name="symbol" value="<?= $item->symbol;?>">
                        </div>
                     </div>  
                     <div class="mb-3">
                        ...
                        <div>
                           <input data-parsley-type="text" type="text"
                              class="form-control" required
                              placeholder="Enter Title" name="hex" value="<?= htmlspecialchars($item->hex);?>">
                        </div>
                     </div>
                  </div>
               </div>
            ...
            <div class="col-lg-3">
               <div class="card">
                  ...
                  <div class="card-body">
                     ...
                     <!-- <div class="mb-3">
                        <label class="form-label mb-3 d-flex">Popular currencies</label>
                        <div class="form-check form-check-inline">
