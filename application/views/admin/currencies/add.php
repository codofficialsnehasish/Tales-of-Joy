<div class="page-content">
   <div class="container-fluid">
      ...
      <!-- end page title -->
      <?= form_open_multipart('admin/currencies/process', 'class="custom-validation"');?>
                  ...
                  <div class="mb-3">
                     ...
                     <div class="mb-3">
                        ...
                        <div>
                           <input data-parsley-type="text" type="text"
                              class="form-control" required
                              placeholder="Enter Title" name="code" value="" required>
                        </div>
                     </div>
                     <div class="mb-3">
                        ...
                        <div>
                           <input data-parsley-type="text" type="text"
                              class="form-control" required
                              placeholder="Enter Title" name="symbol" value="">
                        </div>
                     </div>  
                     <div class="mb-3">
                        ...
                        <div>
                           <input data-parsley-type="text" type="text"
                              class="form-control" required
                              placeholder="Enter Title" name="hex" value="">
                        </div>
                     </div>                  </div>
               </div>
