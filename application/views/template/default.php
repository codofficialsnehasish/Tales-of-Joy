	<!-----------------history section--------------------->
	<section class="history-section" style="background-color: #ffffff;">
		<div class="container">
			<div class="row">
	...
	<div id="hero-area" class="hero-area-bg">
        <div class="container">
          <div class="row">
              <div class="col-md-12 col-sm-12 feature-bg">
              	<h4 class="mb-3"> Terms and Conditions </h4>
                <span> Last Updated: <strong> 05 January 2023</strong> </span> 
                <br>
                <span> &nbsp; </span>
                
                <p> Lorem Ipsum is simply dummy text of the printing and typesetting text ever since the 1500s, 
                	when an unknown printer took a galley of type and scrambled it to make a type specimen book.
                    It has survived not only five centuries, but also the leap into popularised in the 1960s with the
