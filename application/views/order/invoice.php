...
<tr style="height: 18px;">
      ...
      <td style="width: 50%; height: 18px;border: 1px solid #dddddd;text-align: left;padding: 8px;font-size: 12px;">
        ...
        <p><?= $invoice->billing_addr;?></p>
        <p>Pin: <?= $invoice->billing_pin;?></p>
        <p>Phone No. : <?= $invoice->billing_phone;?></p>
...
<table style="width: 800; border-collapse: collapse;font-family: arial, sans-serif;">
 <tr style="height: 18px;">
      ...
      <td style="width: 50%;height: 18px;border: 1px solid #dddddd;text-align: left;padding: 8px;font-size: 12px;">
        ...
        <p><?= $invoice->shipping_addr;?></p>
        <p>Pin: <?= $invoice->shipping_pin;?></p>
        <p>Phone No.: <?= $invoice->shipping_phone;?></p>
        </br></br>
        <p>Place of Supply : <?= select_value_by_id('location_states','id',$invoice->place_of_supply,'name');?></p>
...
<tr style="height: 18px;">
    ...
    <tr style="height: 18px; background:#ffffff;">
      <td style="width: 10%; height: 18px;border: 1px solid #dddddd;text-align: left;padding: 8px;font-size: 12px;">1</td>
      <td style="width: 20%; height: 18px;border: 1px solid #dddddd;text-align: left;padding: 8px;font-size: 12px;"><?= $invoice->product_title;?> </td>
      <td style="width: 10%; height: 18px;border: 1px solid #dddddd;text-align: left;padding: 8px;font-size: 12px;"><?= get_default_currency();?><?= $invoice->unit_price;?></td>
      <td style="width: 10%; height: 18px;border: 1px solid #dddddd;text-align: left;padding: 8px;font-size: 12px;"><?= $invoice->qty;?></td>
      <td style="width: 10%; height: 18px;border: 1px solid #dddddd;text-align: left;padding: 8px;font-size: 12px;"><?= get_default_currency();?><?= $invoice->net_amount;?></td>
      <td style="width: 10%; height: 18px;border: 1px solid #dddddd;text-align: left;padding: 8px;font-size: 12px;"><?= $invoice->gst_rate;?>%</td>
      <td style="width: 10%; height: 18px;border: 1px solid #dddddd;text-align: left;padding: 8px;font-size: 12px;">GST</td>
      <td style="width: 10%; height: 18px;border: 1px solid #dddddd;text-align: left;padding: 8px;font-size: 12px;"><?= get_default_currency();?><?php $gst = $invoice->unit_price*$invoice->gst_rate/100;echo $gst;?></td>
      <td style="width: 10%; height: 18px;border: 1px solid #dddddd;text-align: left;padding: 8px;font-size: 12px;"><?= get_default_currency();?><?= $invoice->net_amount+$gst;?></td>
    </tr>
</table>
...
<table style="width: 800; border-collapse: collapse;font-family: arial, sans-serif;border: 1px solid #dddddd;">
  <tr style="height: 20px; text-align: left; padding: 5px;">
    <td>
      ...
      <td colspan="8">
      <h2 style="margin: 0px; font-size: 16px; padding: 5px;font-family: arial, sans-serif;text-align: right;"><?= get_default_currency();?><?= $invoice->net_amount+$gst;?></h2>
    </td>
  </tr>
  <tr>
</table>
...
<table style="width: 800; border-collapse: collapse;">
  <tr style="height: 18px; text-align: left;">
    <th>
      <p style="font-size: 14px; padding: 5px;font-family: arial, sans-serif;">Amount in Words :<?= numberTowords($invoice->net_amount+$gst);?></p>
    </th>
  </tr>
  <tr>
</table>
