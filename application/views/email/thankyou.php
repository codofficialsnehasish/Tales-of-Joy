...
<tr>
<td>
<table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #000; background-color: #ff940b; width: 700px; margin: 0 auto;" width="700">
<tbody>
<tr>
...
<div align="center" class="alignment" style="line-height:10px"><img alt="Alternate text" src="<?= get_logo();?>" style="height: auto; display: block; border: 0; max-width: 93px; width: 100%;" title="Alternate text" width="93"/></div>
</td>
</tr>
</table>
</td>
...
<div align="center" class="alignment" style="line-height:10px"><img alt="I'm an image" class="fullWidth" src="<?= base_url('assets/images/Welcome_Email.png'); ?>" style="height: auto; display: block; border: 0; max-width: 420px; width: 100%;" title="I'm an image" width="420"/></div>
</td>
</tr>
</table>
...
<p style="margin: 0; word-break: break-word;"><strong><span>Hi <?= $userdata['name'];?>, </span></strong></p>
<p style="margin: 0; word-break: break-word;"><strong><span>welcome to <?= $this->settings->application_name?>!</span></strong></p>
</div>
</td>
</tr>
</table>
...
<p style="margin: 0; word-break: break-word;"><span>Thank you for connect with us!</span></p>
</div>
</td>
</tr>
</table>
...
<tr>
<td style="padding:0 7px 0 7px;"><a href="<?= $this->settings->facebook_url;?>" target="_blank"><img alt="Facebook" height="32" src="<?= base_url('assets/images/facebook2x.png');?>" style="height: auto; display: block; border: 0;" title="Facebook" width="32"/></a></td>
<td style="padding:0 7px 0 7px;"><a href="<?= $this->settings->instagram_url;?>" target="_blank"><img alt="Instagram" height="32" src="<?= base_url('assets/images/instagram2x.png');?>" style="height: auto; display: block; border: 0;" title="Instagram" width="32"/></a></td>
<td style="padding:0 7px 0 7px;"><a href="<?= $this->settings->youtube_url;?>" target="_blank"><img alt="YouTube" height="32" src="<?= base_url('assets/images/youtube2x.png');?>" style="height: auto; display: block; border: 0;" title="YouTube" width="32"/></a></td>
</tr>
</table>
</div>
</td>
...
<div style="color:#000000;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:14px;line-height:200%;text-align:center;mso-line-height-alt:28px;">
<p style="margin: 0; word-break: break-word;">26, Dhapa Rd, Tangra, Kolkata, West Bengal 700105</p>
</div>
</td>
</tr>
</table>
