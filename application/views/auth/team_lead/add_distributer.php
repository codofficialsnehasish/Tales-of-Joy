...
<div id="page-content">
    ...
    <div class="page section-header text-center mb-0">
        <div class="page-title">
            <div class="wrapper"><h1 class="page-width">Distributer Register by TL</h1></div>
        </div>
    </div>
    <!-- End Page Title -->
    <!-- Breadcrumbs -->
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 box">  
                <div class="mb-4">
                    ...
                    <?= form_open_multipart('authentication/reg-process', 'class="needs-validation" name="myform"  novalidate ');?>
                        ...
                        <input type="hidden" value="dristributorbytl" name="reg_opt">
                        <input type="hidden" value="<?= $this->auth_user->id; ?>" name="tl_id">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input id="CustomerFirstName" type="text" name="first_name" placeholder="">
                                </div>
                            </div>
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input id="CustomerLastName" type="text" name="pin_number" placeholder="--- ---">                         
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <label for="CustomerEmail">GST Number <span class="required">*</span></label>
                                    <input id="CustomerEmail" type="text" name="gst_no" placeholder="">                           
                                </div>
                            </div>
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6" id="Voter"> <!-- style="display:none;" -->
                                <div class="form-group">
                                    <label for="Customervoter">Voter Card Number <span class="required">*</span></label>
                                    <input type="text" name="voter_no" id="Customervoter" placeholder="" required>
