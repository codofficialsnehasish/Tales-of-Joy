...
<html lang="en">
<head>
    <title><?php echo $this->general_settings->maintenance_mode_title; ?> - <?php echo $this->settings->application_name; ?></title>
    ...
    <style>
        ...
        .maintenance {
            ...
            background-image: url('<?php echo base_url('assets/images/maintenance_bg.jpg'); ?>');
            z-index: 1;
        }
...
<div class="maintenance">
    <div class="maintenance-inner">
        <div class="content">
            <h1 class="site-title"><?php echo $this->settings->application_name; ?></h1>
