                        ...
                        foreach ($product_images as $image): ?>
                            <div class="item">
                                <a href="<?php echo get_product_image_url($image, 'image_big'); ?>" title="">
                                    ...
                                    <img src="<?php echo IMG_BASE64_1x1; ?>" data-lazy="<?php echo get_product_image_url($image, 'image_big'); ?>" alt="<?php echo html_escape($product->title); ?>" class="img-product-slider block__pic">
                                </a>
                            </div>
                        <?php endforeach;
                    else: ?>
