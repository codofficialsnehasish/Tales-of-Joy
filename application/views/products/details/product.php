...
<!-- Wrapper -->
    <?php $banner = $this->language_model->get_banner_by_page('product'); ?>

<div id="wrapper">
   <div class="product_sticky_banner" style="background: url(<?php echo $banner->image; ?>)">
      <div class="container">
    ...
    <div class="container">
        <div class="row">
                        ...
                        <div class="product-description">
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item active">
                                    <a class="nav-link" id="tab_decorate" data-toggle="tab" href="#tab_decorate_content" role="tab" aria-controls="tab_decorate" aria-selected="true">Product Information</a>
                                </li>
                            ...
                            <div id="accordion" class="tab-content">
                                <div class="tab-pane fade show active" id="tab_decorate_content" role="tabpanel">
                                    <div class="card">
                                        <div class="col-12 p-0 mb-3 " data-test-selector="">
                                           <?php foreach ($custom_fields as $custom_field):
                                                        if (!empty($custom_field->field_value) || !empty($custom_field->field_common_ids)):?>
                                                    <?php echo get_custom_field_value($custom_field); ?>
                                                    <?php endif; ?>
                                                    <?php endforeach; ?>
                                        </div>
            ...
            <div class="col-12 section-related-products">
