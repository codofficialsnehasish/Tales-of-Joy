    ...
    <div class="col-12">
        ...
        <!--<div class="row-custom price">-->
            <div id="product_details_price_container" class="d-inline-block">
                <?php 
                    $data_arr['product'] = $product;
                    if($this->auth_user->role == 'dristributor'){
                        $data_arr['price'] = $product->dis_price;
                        $data_arr['discount_rate'] = $product->dis_discount_rate;
                    }else{
                        $data_arr['price'] = $product->price;
                        $data_arr['discount_rate'] = $product->discount_rate;
                    }
                    // $this->load->view("product/details/_price", ['product' => $product, 'price' => $product->price, 'discount_rate' => $product->discount_rate]); 
                    $this->load->view("product/details/_price", $data_arr); 
                ?>
            </div>
...
<div class="row">
    ...
    <div class="col-12 product-add-to-cart-container">
       <!-- <div class="button-container">
            <a href="javascript:void(0)" style="line-height: 20px !important;" data-product-id="<?php echo $product->id; ?>" data-reload="1" class="buy_Nowbtn btn-block btn-wishlist btn-add-remove-wishlist <?php echo $whislist_button_class; ?>">Order Now</a>
        </div> -->
