...
$config['csrf_exclude_uris'] = array(
                                    ...
                                    'delete-variation-option-post',
                                    'admin/products/get-subcategory',
                                    'admin/services/get-subcategory',
                                    'admin/products/media-process',
									'dmin/media/getLibrary',
                                    'contact-us/process',
                                    'delete-product-images',
                                    'set-main-product-image',
                                    'get-product-temp-images',
                                    'productQuickView',
                                    'add-to-cart',
                                    'fetchCartCount',
                                    'registration',
