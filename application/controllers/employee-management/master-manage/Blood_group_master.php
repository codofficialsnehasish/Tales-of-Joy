...
class Blood_group_master extends Core_Controller {

	public function __construct()
    {
        parent::__construct();
		$this->is_not_logged_in();
		$this->table_name='blood_group_master';
		$this->view_path='employee_management/master_data_manage/blood_group_master/';
	...
	public function index()
	{
		...
		$header['title']='Blood Group Master';
