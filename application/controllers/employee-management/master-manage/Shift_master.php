...
class Shift_master extends Core_Controller {

	public function __construct()
    {
        parent::__construct();
		$this->is_not_logged_in();
		$this->table_name='shift_master';
		$this->view_path='employee_management/master_data_manage/shift_master/';
