...
class Marital_status_master extends Core_Controller {

	public function __construct()
    {
        parent::__construct();
		$this->is_not_logged_in();
		$this->table_name='marital_status_master';
		$this->view_path='master_data_manage/marital_status_master/';
	...
	public function index()
	{
		...
		$header['title']='Marital Status Master';
	...
	{
		$header['pagecss']="";
		$header['title']='Add New Marital Status';
		$this->load->view('partials/header',$header);
		$data['categories']='';
	...
	public function edit()
	{
		...
		$header['pagecss']="";
		$header['title']='Edit Marital Status';
		$this->load->view('partials/header',$header);
