...
class Religion_master extends Core_Controller {

	public function __construct()
    {
        parent::__construct();
		$this->is_not_logged_in();
		$this->table_name='religion_master';
		$this->view_path='master_data_manage/religion_master/';
