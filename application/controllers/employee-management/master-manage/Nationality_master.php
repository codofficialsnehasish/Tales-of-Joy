...
class Nationality_master extends Core_Controller {

	public function __construct()
    {
        parent::__construct();
		$this->is_not_logged_in();
		$this->table_name='nationality_master';
		$this->view_path='master_data_manage/nationality_master/';
	...
	public function index()
	{
		...
		$header['title']='Nationality Master';
	...
	{
		$header['pagecss']="";
		$header['title']='Add New Nationality';
		$this->load->view('partials/header',$header);
		$data['categories']='';
