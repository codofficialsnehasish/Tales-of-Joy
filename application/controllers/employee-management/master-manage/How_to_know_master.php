...
class How_to_know_master extends Core_Controller {

	public function __construct()
    {
        parent::__construct();
		$this->is_not_logged_in();
		$this->table_name='how_to_know_master';
		$this->view_path='master_data_manage/how_to_know_master/';
	...
	public function index()
	{
		...
		$header['title']='How To Know Master';
	...
	{
		$header['pagecss']="";
		$header['title']='Add New How To Know';
		$this->load->view('partials/header',$header);
		$data['categories']='';
