...
class Medical_history_master extends Core_Controller {

	public function __construct()
    {
        parent::__construct();
		$this->is_not_logged_in();
		$this->table_name='medical_history_master';
		$this->view_path='master_data_manage/medical_history_master/';
	...
	public function index()
	{
		...
		$header['title']='Medical History Master';
	...
	{
		$header['pagecss']="";
		$header['title']='Add New Medical History';
		$this->load->view('partials/header',$header);
		$data['categories']='';
